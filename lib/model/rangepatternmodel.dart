class RangePatternModel {
  List<RangeOfPattern> rangeOfPattern = const [];
  List<DesignOccasion> designOccasion = const [];
  String? status;
  String? message;

  RangePatternModel(
      {this.rangeOfPattern = const [], this.designOccasion = const [], this.status, this.message});

  RangePatternModel.fromJson(Map<String, dynamic> json) {
