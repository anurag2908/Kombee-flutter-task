class ShopCategorymodel {
  List<ShopByCategory> shopByCategory = const [];
  List<ShopByFabric> shopByFabric = const [];
  List<Unstitched> unstitched = const [];
  List<BoutiqueCollection> boutiqueCollection = const [];
  String? status;
  String? message;
