class MainStickyModel {
  List<MainStickyMenu> mainStickyMenu = const [];
  String? status;
  String? message;

  MainStickyModel({this.mainStickyMenu = const [], this.status, this.message});

  MainStickyModel.fromJson(Map<String, dynamic> json) {
...
class MainStickyMenu {
  ...
  String? image;
  String? sortOrder;
  List<SliderImages> sliderImages = const [];
